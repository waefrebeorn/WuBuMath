...
$(BIN)/test_gs $(BIN)/test_tl $(BIN)/test_ir $(BIN)/test_hil $(BIN)/test_st $(BIN)/test_fexp $(BIN)/test_ai2 $(BIN)/test_qr $(BIN)/test_sc $(BIN)/test_bq $(BIN)/test_sp $(BIN)/test_qcodec $(BIN)/test_qi $(BIN)/test_qfinal $(BIN)/test_qz $(BIN)/test_dq $(BIN)/test_scl $(BIN)/test_qsp $(BIN)/test_kfs $(BIN)/test_ksg $(BIN)/test_cv2 $(BIN)/test_dct $(BIN)/test_zr $(BIN)/test_eg2 $(BIN)/test_db $(BIN)/test_ip $(BIN)/test_me $(BIN)/test_yuv $(BIN)/test_mvp $(BIN)/test_dpb $(BIN)/test_cabac $(BIN)/test_part $(BIN)/test_p2 $(BIN)/test_mc2 $(BIN)/test_ang $(BIN)/test_sao $(BIN)/test_ssim $(BIN)/test_rdo $(BIN)/test_scene $(BIN)/test_color $(BIN)/test_nal $(BIN)/test_bf2 $(BIN)/test_fgs $(BIN)/test_hdr $(BIN)/test_nc $(BIN)/test_360 $(BIN)/test_db2 $(BIN)/test_cclm $(BIN)/test_trel $(BIN)/test_sdct $(BIN)/test_fm $(BIN)/test_hdpc: $(SRC)/tests/test_wubu_hdpc.c $(SRC)/math/wubu_hdpc.c
	@mkdir -p $(BIN)
	$(CC) $(CFLAGS) -I$(INC) $(SRC)/math/wubu_hdpc.c $< -o $@ $(LDFLAGS)

$(BIN)/test_wubuv: $(SRC)/tests/test_wubuv.c $(SRC)/audio/wubuv.c
	@mkdir -p $(BIN)
	$(CC) $(CFLAGS) -I$(INC) $(SRC)/audio/wubuv.c $< -o $@ $(LDFLAGS)

$(BIN)/test_lr: $(SRC)/tests/test_wubu_lrsched.c $(SRC)/train/wubu_lrsched.c
	@mkdir -p $(BIN)
	$(CC) $(CFLAGS) -I$(INC) $(SRC)/train/wubu_lrsched.c $< -o $@ $(LDFLAGS)
...
$(BIN)/test_kg: $(SRC)/tests/test_wubu_kgtrans.c $(SRC)/train/wubu_kgtrans.c
	@mkdir -p $(BIN)
	$(CC) $(CFLAGS) -I$(INC) $(SRC)/train/wubu_kgtrans.c $< -o $@ $(LDFLAGS)

$(BIN)/test_mh: $(SRC)/tests/test_wubu_multihop.c $(SRC)/math/wubu_multihop.c
	@mkdir -p $(BIN)
	$(CC) $(CFLAGS) -I$(INC) $(SRC)/math/wubu_multihop.c $< -o $@ $(LDFLAGS)

$(BIN)/test_hpq: $(SRC)/tests/test_wubu_hpq.c $(SRC)/audio/wubu_hpq.c
	@mkdir -p $(BIN)
	$(CC) $(CFLAGS) -I$(INC) $(SRC)/audio/wubu_hpq.c $< -o $@ $(LDFLAGS)
...
$(BIN)/test_ha2: $(SRC)/tests/test_wubu_hanalogy.c $(SRC)/train/wubu_hanalogy.c
	@mkdir -p $(BIN)
	$(CC) $(CFLAGS) -I$(INC) $(SRC)/train/wubu_hanalogy.c $< -o $@ $(LDFLAGS)
...
$(BIN)/test_um: $(SRC)/tests/test_wubu_humap.c $(SRC)/math/wubu_humap.c
	@mkdir -p $(BIN)
	$(CC) $(CFLAGS) -I$(INC) $(SRC)/math/wubu_humap.c $< -o $@ $(LDFLAGS)
...
$(BIN)/test_hd2: $(SRC)/tests/test_wubu_hdropout.c $(SRC)/math/wubu_hdropout.c
	@mkdir -p $(BIN)
	$(CC) $(CFLAGS) -I$(INC) $(SRC)/math/wubu_hdropout.c $< -o $@ $(LDFLAGS)

$(BIN)/test_moe: $(SRC)/tests/test_wubu_hmoe.c $(SRC)/math/wubu_hmoe.c
	@mkdir -p $(BIN)
	$(CC) $(CFLAGS) -I$(INC) $(SRC)/math/wubu_hmoe.c $< -o $@ $(LDFLAGS)

$(BIN)/test_sn: $(SRC)/tests/test_wubu_specnorm.c $(SRC)/math/wubu_specnorm.c
	@mkdir -p $(BIN)
	$(CC) $(CFLAGS) -I$(INC) $(SRC)/math/wubu_specnorm.c $< -o $@ $(LDFLAGS)
...
$(BIN)/test_hp: $(SRC)/tests/test_wubu_hppo.c $(SRC)/train/wubu_hppo.c
	@mkdir -p $(BIN)
	$(CC) $(CFLAGS) -I$(INC) $(SRC)/train/wubu_hppo.c $< -o $@ $(LDFLAGS)

$(BIN)/test_rp: $(SRC)/tests/test_wubu_hreplay.c $(SRC)/train/wubu_hreplay.c
	@mkdir -p $(BIN)
	$(CC) $(CFLAGS) -I$(INC) $(SRC)/train/wubu_hreplay.c $< -o $@ $(LDFLAGS)

$(BIN)/test_hb: $(SRC)/tests/test_wubu_hbandit.c $(SRC)/train/wubu_hbandit.c
	@mkdir -p $(BIN)
	$(CC) $(CFLAGS) -I$(INC) $(SRC)/train/wubu_hbandit.c $< -o $@ $(LDFLAGS)
...
test: $(BIN)/test_vhf_engine $(BIN)/test_gaad $(BIN)/wubu_tests $(BIN)/jax_test $(BIN)/nn_test $(BIN)/test_hyperbolic $(BIN)/test_quaternion $(BIN)/test_so3 $(BIN)/test_rep $(BIN)/test_manifold $(BIN)/test_anyon $(BIN)/test_pgeom $(BIN)/test_riemannian_sgd $(BIN)/test_parallel_transport $(BIN)/test_hyperbolic_analytics $(BIN)/test_manifold_ad $(BIN)/test_lorentz $(BIN)/test_lorentz_poincare $(BIN)/test_tangent_flow $(BIN)/test_flow_matching $(BIN)/test_manifold_clip $(BIN)/test_beam $(BIN)/test_beam_8k $(BIN)/test_decode_quality $(BIN)/test_text_encoder $(BIN)/test_bands $(BIN)/test_lorflow $(BIN)/test_quat_prop $(BIN)/test_arena $(BIN)/test_lorclip $(BIN)/test_hattn $(BIN)/test_hmlr $(BIN)/test_ldirect $(BIN)/test_hkmeans $(BIN)/test_hlin $(BIN)/test_hact $(BIN)/test_uv $(BIN)/test_kodak $(BIN)/test_pframe_ir $(BIN)/test_uv $(BIN)/test_pairs $(BIN)/test_avfid $(BIN)/test_stft $(BIN)/test_latent_codec $(BIN)/test_nest_gpt $(BIN)/test_quat_ops $(BIN)/test_canvas_res $(BIN)/test_nested_enc $(BIN)/test_learned
	...
	@echo "=== Hyperbolic Bandit ===" && $(BIN)/test_hb
	...
	@echo "=== Spectral Normalization ===" && $(BIN)/test_sn
	...
	@echo "=== Hyperbolic RVQ ===" && $(BIN)/test_hpq
...
$(BIN)/test_hil: src/tests/test_wubu_hil.c src/math/wubu_hilbert.c src/math/wubu_golden_scan.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/math/wubu_hilbert.c src/math/wubu_golden_scan.c $< -o $@ -lm

$(BIN)/test_st: src/tests/test_wubu_st.c src/math/wubu_sweeptime.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/math/wubu_sweeptime.c $< -o $@ -lm

$(BIN)/test_fexp: src/tests/test_wubu_fexp.c src/train/wubu_flow_exp.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/train/wubu_flow_exp.c $< -o $@ -lm

$(BIN)/test_ai2: src/tests/test_wubu_ai2.c src/audio/wubu_aud2img.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/audio/wubu_aud2img.c $< -o $@ -lm

$(BIN)/test_qr: src/tests/test_wubu_quat_rate.c src/train/wubu_quat_rate.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/train/wubu_quat_rate.c $< -o $@ -lm

$(BIN)/test_sc: src/tests/test_wubu_scene_cut.c src/train/wubu_scene_cut.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/train/wubu_scene_cut.c $< -o $@ -lm

$(BIN)/test_bq: src/tests/test_wubu_bench_quality.c src/math/wubu_bench_quality.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/math/wubu_bench_quality.c $< -o $@ -lm

$(BIN)/test_sp: src/tests/test_wubu_rd_subpix.c src/math/wubu_rd_subpix.c src/math/wubu_bench_quality.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_rd_subpix.c src/math/wubu_bench_quality.c $< -o $@ -lm

$(BIN)/test_qcodec: src/tests/test_wubu_quat_codec.c src/train/wubu_quat_codec.c src/math/wubu_bench_quality.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/train/wubu_quat_codec.c src/math/wubu_bench_quality.c $< -o $@ -lm

$(BIN)/test_qi: src/tests/test_wubu_qc_improve.c src/train/wubu_qc_improve.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/train/wubu_qc_improve.c $< -o $@ -lm

$(BIN)/test_qfinal: src/tests/test_wubu_qc_final.c src/train/wubu_qc_final.c src/math/wubu_bench_quality.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/train/wubu_qc_final.c src/math/wubu_bench_quality.c $< -o $@ -lm

$(BIN)/test_qz: src/tests/test_wubu_qc_zlib.c src/train/wubu_qc_zlib.c src/math/wubu_bench_quality.c
	@mkdir -p bin
	$(CC) -std=c11 -g -fsanitize=address -Iinclude -DM_PI=3.14159265358979f src/train/wubu_qc_zlib.c src/math/wubu_bench_quality.c $< -o $@ -lz -lm
...
$(BIN)/test_qsp: src/tests/test_wubu_qspline.c src/math/wubu_qspline.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_qspline.c $< -o $@ -lm

$(BIN)/test_kfs: src/tests/test_wubu_keyselect.c src/train/wubu_keyselect.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/train/wubu_keyselect.c $< -o $@ -lm

$(BIN)/test_ksg: src/tests/test_wubu_kseg.c src/train/wubu_kseg.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/train/wubu_kseg.c $< -o $@ -lm

$(BIN)/test_cv2: src/tests/test_wubu_codec_v2.c src/train/wubu_codec_v2.c src/train/wubu_kseg.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/train/wubu_codec_v2.c src/train/wubu_kseg.c $< -o $@ -lz -lm

$(BIN)/test_dct: src/tests/test_wubu_dct.c src/math/wubu_idct8x8.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_idct8x8.c $< -o $@ -lm

$(BIN)/test_zr: src/tests/test_wubu_zigrle.c src/math/wubu_zigrle.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/math/wubu_zigrle.c $< -o $@ -lm

$(BIN)/test_eg2: src/tests/test_wubu_expgolomb2.c src/math/wubu_expgolomb2.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/math/wubu_expgolomb2.c $< -o $@ -lm

$(BIN)/test_db: src/tests/test_wubu_deblock.c src/math/wubu_deblock.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/math/wubu_deblock.c $< -o $@ -lm

$(BIN)/test_ip: src/tests/test_wubu_intra.c src/math/wubu_intra.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_intra.c $< -o $@ -lm

$(BIN)/test_me: src/tests/test_wubu_motionest.c src/math/wubu_motionest.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/math/wubu_motionest.c $< -o $@ -lm

$(BIN)/test_yuv: src/tests/test_wubu_yuv420.c src/math/wubu_yuv420.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/math/wubu_yuv420.c $< -o $@ -lm

$(BIN)/test_mvp: src/tests/test_wubu_mvprep.c src/math/wubu_mvprep.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_mvprep.c $< -o $@ -lm

$(BIN)/test_dpb: src/tests/test_wubu_dpb.c src/math/wubu_dpb.c src/math/wubu_motionest.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_dpb.c src/math/wubu_motionest.c $< -o $@ -lm

$(BIN)/test_cabac: src/tests/test_wubu_cabac.c src/math/wubu_cabac.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/math/wubu_cabac.c $< -o $@ -lm

$(BIN)/test_part: src/tests/test_wubu_partitions.c src/math/wubu_partitions.c src/math/wubu_motionest.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/math/wubu_partitions.c src/math/wubu_motionest.c $< -o $@ -lm

$(BIN)/test_p2: src/tests/test_wubu_part2.c src/math/wubu_part2.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/math/wubu_part2.c $< -o $@ -lm

$(BIN)/test_mc2: src/tests/test_wubu_mc2.c src/math/wubu_mc2.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/math/wubu_mc2.c $< -o $@ -lm

$(BIN)/test_ang: src/tests/test_wubu_angular.c src/math/wubu_angular.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_angular.c $< -o $@ -lm
...
$(BIN)/test_rdo: src/tests/test_wubu_rdo.c src/math/wubu_rdo.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_rdo.c $< -o $@ -lm

$(BIN)/test_scene: src/tests/test_wubu_scene.c src/math/wubu_scene.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_scene.c $< -o $@ -lm

$(BIN)/test_color: src/tests/test_wubu_color.c src/math/wubu_color.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_color.c $< -o $@ -lm

$(BIN)/test_nal: src/tests/test_wubu_nal.c src/math/wubu_nal.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/math/wubu_nal.c $< -o $@ -lm

$(BIN)/test_bf2: src/tests/test_wubu_bframe2.c src/math/wubu_bframe2.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/math/wubu_bframe2.c $< -o $@ -lm

$(BIN)/test_fgs: src/tests/test_wubu_fgs.c src/math/wubu_fgs.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_fgs.c $< -o $@ -lm

$(BIN)/test_hdr: src/tests/test_wubu_hdr.c src/math/wubu_hdr.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_hdr.c $< -o $@ -lm

$(BIN)/test_nc: src/tests/test_wubu_ncodec.c src/math/wubu_ncodec.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_ncodec.c $< -o $@ -lm

$(BIN)/test_360: src/tests/test_wubu_360.c src/math/wubu_360.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_360.c $< -o $@ -lm

$(BIN)/test_db2: src/tests/test_wubu_deblock2.c src/math/wubu_deblock2.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude src/math/wubu_deblock2.c $< -o $@ -lm

$(BIN)/test_cclm: src/tests/test_wubu_cclm.c src/math/wubu_cclm.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_cclm.c $< -o $@ -lm

$(BIN)/test_trel: src/tests/test_wubu_trellis.c src/math/wubu_trellis.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_trellis.c $< -o $@ -lm

$(BIN)/test_sdct: src/tests/test_wubu_simd_dct.c src/math/wubu_simd_dct.c src/math/wubu_transform.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -mavx2 -Iinclude src/math/wubu_simd_dct.c src/math/wubu_transform.c $< -o $@ -lm

$(BIN)/test_fm: src/tests/test_wubu_fastmode.c src/math/wubu_fastmode.c
	@mkdir -p bin
	$(CC) $(CFLAGS) -Iinclude -DM_PI=3.14159265358979f src/math/wubu_fastmode.c $< -o $@ -lm
